            ...
            <div className="fotos">
                <div className="fotos-ajuste">
                    <div className="parent">
                        <Link to="/vinho" ><h3 className="vinhos-btn">O Vinho</h3></Link>
                        <div className="child" style={style1}></div>

                    </div>
                    <div className="parent">
                        <Link to="/vinho"><h3 className="visitas-btn">Visitas</h3></Link>
                        <div className="child" style={style2}></div>
                    </div>
                    <div className="parent">
                        <Link to="/vinho"><h3 className="eventos-btn">Eventos </h3></Link>
                        <div className="child" style={style3} ></div>
                    </div>
                    <div className="parent">
                        <Link to="/vinho"><h3 className="vinha-btn">A Vinha</h3></Link>
